...
const Responsive = () => {
  return (
    ...
    <div
      className={`md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white p-4 transition-transform duration-300 ease-in-out transform translate-y-0 rounded-t-3xl shadow-[0_-2px_10px_rgba(0,0,0,0.1)]`}
    >
      <div>
        <div className="grid grid-cols-4 gap-4 text-center">
          ...
          <Link
            href="/#about"
            className="flex flex-col items-center hover:text-pink-500 r"
          >
