    ...
    >
      <div className="flex flex-row items-center justify-center gap-10">
        <div className="flex flex-col  gap-10 ">
          <Link
            href="https://www.linkedin.com/in/harikaran-r-29553121a/"
            className="    text-pink-600 hover:-translate-y-3/12 transition-all duration-300"
            target="_blank"
          >
          ...
          <Link
            ...
            target="_blank"
          >
            <Icon icon="uil:github-alt" width="24" height="24" />
          </Link>
          <Link
            href="https://www.cloudskillsboost.google/public_profiles/161c87ab-19f9-4b6a-b6d1-4f77ebb0cc19"
            className="  text-pink-600 hover:-translate-y-3/12 transition-all duration-300"
            target="_blank"
          >
            <Icon icon="uim:google" width="24" height="24" />
          </Link>
          <Link
            ...
            target="_blank"
          >
            <Icon icon="icon-park-outline:dribble" width="24" height="24" />
          </Link>
          <Link
            href="https://www.facebook.com/share/1653xihyo2/"
            className="  text-pink-600 hover:-translate-y-3/12 transition-all duration-300"
            target="_blank"
          >
...
const HomePage   = () => {
    ...
    return (
        <div id='home' data-aos="fade-down-right"  className="flex flex-col items-center justify-center h-screen w-full bg-white gap-5 p-10">
            <div className='flex flex-row items-center justify-center gap-10' >
            <div className='flex flex-col  gap-10 ' >
...
/>
                    <h1 className='text-2xl md:text-5xl font-bold'>Hi, I&#39;m Harikaran</h1>
                    <p className='hover:bg-pink-300 duration-1000 text-center text-sm  md:text-2xl font-semibold text-pink-600'>&lt; Software Engineering Student &amp; Full-stack JS Developer /&gt;</p>
...
>>>>>>> 611e201a308ca5d54683f595f791ef292109334d
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <p className="hover:bg-pink-300 duration-1000 text-center text-sm  md:text-2xl font-semibold text-pink-600">
            &lt; Software Engineering Student &amp; Full-stack JS Developer
            /&gt;
          </p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-4 items-center">
        <Link
          href="/#contact"
          className="h-12 bg-pink-600 text-white px-4 py-2 rounded-md hover:bg-pink-700 transition duration-300 flex gap-2 items-center"
        >
          Get in Touch{" "}
          <Icon
            icon="proicons:send"
